...
--
-- Gép: localhost:3306
-- Létrehozás ideje: 2025. Feb 02. 11:39
...
-- Eljárások
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `addNewUser` (IN `firstnameIn` INT, IN `lastnameIn` INT, IN `ageIn` INT, IN `emailIn` INT, IN `passwordIn` INT, IN `phoneNumberIn` INT)   INSERT INTO `user`VALUES(NULL, firstnameIn,lastnameIn,ageIn,emailIn,sha1(passwordIn),phoneNumberIn)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `deletedUser` (IN `userIdIN` INT)   UPDATE `user`
...
(1, 'Minta', 'Péter', 25, 'Mintapeter11@gmail.com', '447d51f174e77350c26333cffd2b1470b769865d', '06203456780', NULL, NULL, NULL, NULL),
(2, 'Minta ', 'Lajos', 22, 'Mintalajos10@gmail.com', '447d51f174e77350c26333cffd2b1470b769865d', '06704567432', NULL, NULL, NULL, NULL),
(3, 'Minta', 'Csaba', 43, 'MintaCs@gmail.com', '2e8b5d3318eca981223944355fa7aa65be376ff6', '06203516265', NULL, NULL, 1, '2025-01-31 13:30:20'),
(4, 'Minta ', 'Elemér', 25, 'MintaEl@gmail.com', '9232af1a58b175c0141191e7f47ee8d75d2931a0\r\n\r\n', '067025465125', NULL, NULL, NULL, NULL);
